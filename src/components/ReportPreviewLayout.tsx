...
import { ChartBar, ChartLine, ChartPie, Table as TableIcon, SquaresFour } from '@phosphor-icons/react';
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          This is how your report will look with the selected theme and requirements
        </p>
      </div>

      <Card className="p-4 overflow-hidden" style={{ backgroundColor }}>
        <div className="space-y-4">
          <div 
