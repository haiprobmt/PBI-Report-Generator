...
export function StepIndicator({ currentStep, onStepClick }: StepIndicatorProps) {
  ...
  const steps: { id: WorkflowStep; label: string; number: number }[] = [
    { id: 'upload', label: t('sourceKnowledge'), number: 1 },
    { id: 'requirements', label: t('biClarification'), number: 2 },
    { id: 'layout', label: t('penLayout'), number: 3 },
    { id: 'download', label: t('agentInstructions'), number: 4 },
  ];
